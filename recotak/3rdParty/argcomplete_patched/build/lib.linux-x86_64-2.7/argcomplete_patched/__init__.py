...
class CompletionFinder(object):
    ...
    def _patch_argument_parser(self):
        ...
        global g_active_parsers
        g_active_parsers = [self._parser]
                ...
                class IntrospectAction(action.__class__):
                    def __call__(self, parser, namespace, values, option_string=None):
                        ...
                        if self._orig_class == argparse._SubParsersAction:
                            ...
                            global g_active_parsers
                            if active_subparser not in g_active_parsers:
                                g_active_parsers.append(active_subparser)
        ...
        return g_active_parsers, parsed_args
